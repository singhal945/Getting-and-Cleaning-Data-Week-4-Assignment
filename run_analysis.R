...
Step4: Appropriately labels the data set with descriptive variables names
...
Step5: From the data set in step4, creates a second, independent tidy data set with average of each variable for each activity and each subject.
